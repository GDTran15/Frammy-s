    ...
    return (
      ...
      <nav className="navbar bg-black fixed-top">
        <div className="container small ">
          ...
          <div>
            <Link to="/weekly-result-summary" className="btn btn-outline-warning me-2 btn-sm">Weekly Results</Link>
          </div>

          <div>
            <Link to="/login" className="btn btn-outline-warning me-2 btn-sm">Login</Link>
            ...
            <div className="col">
              ...
              <div className="d-flex flex-column flex-md-row justify-content-center gap-2">
                <Link href="/login" className="btn btn-warning">
                    ...
                    Start Voting</Link>
                <Link href="/user/prediction" className="btn btn-outline-warning">
