            ...
            <section className="feature bg-body-tertiary">
                ...
                <div className="container">
                    <div className="row justify-content-center text-center">
                        <div className="col">
                            <h5 className="fs-3">Make a Prediction</h5>
                            <p className="fs-5 text-secondary">Make your predictions for the Grammy Awards! Who do you think will take home the coveted trophies this year? Share your thoughts and join the conversation.</p>
                        </div>
                    </div>
                </div>
